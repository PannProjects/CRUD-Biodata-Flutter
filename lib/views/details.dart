...
import 'package:biodata_flutter/views/edit.dart';
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text("ID : ${widget.sw.id}", style: TextStyle(fontSize: 20)),
              Text("NIS : ${widget.sw.nis}", style: TextStyle(fontSize: 20)),
              Padding(padding: EdgeInsets.all(10)),
              Text("NAMA  : ${widget.sw.nama}", style: TextStyle(fontSize: 20)),
              Text(
